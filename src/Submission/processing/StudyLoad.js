...
export default function StudyLoad({requirement, defaultDocument, onDocChange}) {
    ...
    const step1 = () => {
        return <div className='uploaad-file'>
            <h2>Study Load</h2>
            <p>1. Upload you most recent study load showing that you have already enrolled in the OJT program</p>
            <p>2. Follow the filename “Lastname_StudyLoad.pdf”</p>
