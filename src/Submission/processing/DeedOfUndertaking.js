...
export default function DeedOfUndertaking({requirement, defaultDocument, onDocChange}) {
    ...
    const step1 = () => {
        return <div className='download-file'>
            ...
            <ol>
                <li>Download the file below.<br/><a href="/documents/DeedofUndertaking.pdf">Deedofundertaking.pdf</a></li>
    ...
    const step2 = () => {
        return <div className='upload-file'>
            <h2>Upload Deed of Undertaking</h2>
            <p>1. Follow the filename “Lastname_DeedofUndertaking.pdf”</p>
